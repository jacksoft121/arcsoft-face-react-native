...
exports.ArcFaceRegistry = void 0;
var _reactNative = require("react-native");
const Native = _reactNative.NativeModules.ArcFaceModule;
function getNative() {
  if (!Native) {
    throw new Error(`[arcsoft-face-react-native] Native module "ArcFaceModule" not found. ` + `Make sure the library is linked and rebuild the app. Platform=${_reactNative.Platform.OS}`);
  }
  return Native;
}
...
const ArcFaceRegistry = exports.ArcFaceRegistry = {
