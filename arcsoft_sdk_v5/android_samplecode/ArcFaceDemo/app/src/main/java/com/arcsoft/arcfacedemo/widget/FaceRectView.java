...
public class FaceRectView extends View {
    ...
    public static class DrawInfo {
        ...
        public DrawInfo(Rect rect, int sex, int age, int liveness, int color, String name, int isWithinBoundary,
                        Rect foreheadRect, boolean drawRectInfo, boolean rgbRect) {
            this.rect = rect;
            this.sex = sex;
            this.age = age;
            this.liveness = liveness;
