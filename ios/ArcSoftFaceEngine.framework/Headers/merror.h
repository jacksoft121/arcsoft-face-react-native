...
#define MERR_ASF_EX_FEATURE_UNINITED                        (MERR_ASF_EX_BASE+2)                //需要检测是属性未初始化
#define MERR_ASF_EX_FEATURE_UNPROCESSED                        (MERR_ASF_EX_BASE+3)                //待获取的属性未在process中处理过
#define MERR_ASF_EX_FEATURE_UNSUPPORTED_ON_PROCESS            (MERR_ASF_EX_BASE+4)                //PROCESS不支持的检测属性，例如FR，有自己独立的处理函数
...
#define MERR_ASF_INIT_BASE                               (0x21000)                         //初始化错误
...
#define MERR_ASF_SEARCH_NUM_OVER_LIMIT                  (MERR_ASF_SEARCH_BASE+5)        //人脸查询数量超过已经注册的人脸底库数量
