...
namespace margelo::nitro::arcsoftfacern {
  ...
  /**
   * A struct which can be represented as a JavaScript object (ArcsoftFrameRect).
   */
  struct ArcsoftFrameRect final {
  public:
  ...
  public:
    ArcsoftFrameRect() = default;
    explicit ArcsoftFrameRect(double left, double top, double right, double bottom): left(left), top(top), right(right), bottom(bottom) {}

  public:
    friend bool operator==(const ArcsoftFrameRect& lhs, const ArcsoftFrameRect& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ ArcsoftFrameRect <> JS ArcsoftFrameRect (object)
  template <>
  struct JSIConverter<margelo::nitro::arcsoftfacern::ArcsoftFrameRect> final {
    static inline margelo::nitro::arcsoftfacern::ArcsoftFrameRect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::arcsoftfacern::ArcsoftFrameRect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::arcsoftfacern::ArcsoftFrameRect& arg) {
